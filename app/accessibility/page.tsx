  ...
  return (
    <>
      ...
      <section className="py-section-gap max-w-3xl mx-auto px-margin-mobile md:px-margin-desktop text-on-surface-variant leading-relaxed space-y-6">
        ...
        <h2 className="font-headline-md text-headline-md text-on-surface">The property</h2>
        <p>
          For questions about accessibility features of the rooms or property, please contact us
