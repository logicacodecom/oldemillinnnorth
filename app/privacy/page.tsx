  ...
  return (
    <>
      ...
      <section className="py-section-gap max-w-3xl mx-auto px-margin-mobile md:px-margin-desktop text-on-surface-variant leading-relaxed space-y-6">
        ...
        <p>If you use our contact form, we collect the details you provide — such as your name, email address, optional phone number, optional move-in and move-out dates and your message — so we can respond to your inquiry.</p>
        ...
        <p>Map and directions links open Google Maps. Links to our sister property open its own website, which has its own privacy practices.</p>
