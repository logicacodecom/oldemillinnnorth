...
// Filterable photo grid with a keyboard-accessible lightbox. Filter tabs only
// render when there is more than one category.
  ...
  return (
    <div>
      ...
      <ul className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
        {visible.map((photo, i) => (
          <li key={photo.src + photo.categoryId}>
            <button
              type="button"
